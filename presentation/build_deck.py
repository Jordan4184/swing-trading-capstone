...
def add_bullets(slide, bullets, left, top, width, height, *,
                font_size=16, color=TEXT_DARK, font=BODY_FONT,
                line_spacing=1.3):
    """Add a bulleted list."""
    tx = slide.shapes.add_textbox(left, top, width, height)
    tf = tx.text_frame
...
def add_slide_header(slide, title, subtitle=None):
    ...
    add_text(slide, title, Inches(0.6), Inches(0.4), Inches(12), Inches(0.7),
             font_size=32, bold=True, color=DEEP_BLUE, font=HEADER_FONT)
    if subtitle:
        add_text(slide, subtitle, Inches(0.6), Inches(1.05), Inches(12), Inches(0.4),
                 font_size=14, color=TEXT_MUTED, font=BODY_FONT)


def add_slide_number(slide, n, total=16):
    """Discrete slide number bottom right."""
    add_text(slide, f"{n} / {total}",
             Inches(12.4), Inches(7.0), Inches(0.8), Inches(0.3),
             font_size=10, color=TEXT_MUTED, align=PP_ALIGN.RIGHT)


def add_stat_callout(slide, value, label, left, top, width, height, *,
                     value_color=DEEP_BLUE, value_size=44):
    """Big stat number with small label below."""
    add_text(slide, value, left, top, width, Inches(0.9),
...
def slide_01_title(prs, data):
    ...
    dot = slide.shapes.add_shape(
        MSO_SHAPE.OVAL, Inches(0.8), Inches(0.8),
    ...
    add_text(slide, "CAPSTONE PROJECT — DATA SCIENCE & AI",
             Inches(1.2), Inches(0.78), Inches(10), Inches(0.3),
             font_size=12, bold=True, color=ACCENT, font=BODY_FONT)

    add_text(slide,
             "ML-Based Cross-Sectional\nSwing Trading Strategy",
             Inches(0.8), Inches(2.2), Inches(11.5), Inches(2.2),
             font_size=54, bold=True, color=WHITE, font=HEADER_FONT)

    add_text(slide,
             "Predicting forward returns with walk-forward machine learning,\n"
             "evaluated against honest benchmarks.",
             Inches(0.8), Inches(4.6), Inches(11), Inches(1),
             font_size=20, color=RGBColor(0xCA, 0xDC, 0xFC), font=BODY_FONT)

    add_text(slide, "Jordan Donaldson",
             Inches(0.8), Inches(6.4), Inches(8), Inches(0.4),
             font_size=18, bold=True, color=WHITE)
    add_text(slide, "Institute of Data  |  May 2026",
             Inches(0.8), Inches(6.8), Inches(8), Inches(0.4),
             font_size=14, color=RGBColor(0xCA, 0xDC, 0xFC))
...
def slide_02_agenda(prs, data):
    ...
    for num, head, desc in items:
        ...
        add_text(slide, num, Inches(0.8), y, Inches(0.7), Inches(0.7),
                 font_size=18, bold=True, color=WHITE,
                 align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)

        add_text(slide, head, Inches(1.7), y - Inches(0.05), Inches(11), Inches(0.5),
                 font_size=22, bold=True, color=TEXT_DARK)
        add_text(slide, desc, Inches(1.7), y + Inches(0.45), Inches(11), Inches(0.4),
...
def slide_03_bio(prs, data):
    ...
    add_text(slide, "Jordan Donaldson",
             Inches(0.8), Inches(1.7), Inches(8), Inches(0.5),
             font_size=28, bold=True, color=DEEP_BLUE)
    add_text(slide, "Aspiring ML / AI Engineer",
             Inches(0.8), Inches(2.25), Inches(8), Inches(0.4),
    ...
    add_bullets(slide, bullets, Inches(0.8), Inches(3.0), Inches(11.5), Inches(4),
                font_size=16)
...
def slide_04_context(prs, data):
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "Why this project, why now",
    ...
    add_text(slide, "JUNE 4", Inches(0.8), Inches(2.2), Inches(4.5), Inches(0.6),
             font_size=18, bold=True, color=ACCENT,
             align=PP_ALIGN.CENTER, font=HEADER_FONT)
    add_text(slide, "2026", Inches(0.8), Inches(2.8), Inches(4.5), Inches(1.6),
             font_size=80, bold=True, color=WHITE,
             align=PP_ALIGN.CENTER, font=HEADER_FONT)
    add_text(slide,
             "FINRA removes the\nPattern Day Trader rule",
             Inches(0.8), Inches(4.4), Inches(4.5), Inches(1.0),
             font_size=18, color=WHITE,
             align=PP_ALIGN.CENTER, font=BODY_FONT)
    add_text(slide,
             "$25k minimum equity\nrequirement eliminated",
             Inches(0.8), Inches(5.5), Inches(4.5), Inches(1.0),
             font_size=14, color=RGBColor(0xCA, 0xDC, 0xFC),
             align=PP_ALIGN.CENTER, font=BODY_FONT)

    # Right side narrative
    add_text(slide, "What changes",
             Inches(5.8), Inches(2.0), Inches(7), Inches(0.5),
             font_size=20, bold=True, color=DEEP_BLUE)
    ...
    add_bullets(slide, bullets, Inches(5.8), Inches(2.6), Inches(7), Inches(4),
                font_size=15)
...
def slide_05_define_business(prs, data):
    ...
    add_text(slide, "Problem statement",
             Inches(0.8), Inches(1.7), Inches(6), Inches(0.5),
             font_size=20, bold=True, color=DEEP_BLUE)
    ...
    add_text(slide,
             ...
             Inches(0.8), Inches(2.3), Inches(6), Inches(2.2),
             font_size=15, color=TEXT_DARK)

    add_text(slide, "Why this matters",
             Inches(0.8), Inches(4.7), Inches(6), Inches(0.5),
             font_size=20, bold=True, color=DEEP_BLUE)
    ...
    add_bullets(slide, bullets_left, Inches(0.8), Inches(5.3), Inches(6), Inches(2),
                font_size=14)

    # Right column — success criteria
    add_text(slide, "Success criteria",
             Inches(7.3), Inches(1.7), Inches(5.5), Inches(0.5),
             font_size=20, bold=True, color=DEEP_BLUE)
    ...
    add_bullets(slide, success, Inches(7.3), Inches(2.3), Inches(5.5), Inches(5),
                font_size=14)
...
def slide_06_define_data(prs, data):
    ...
    for value, label in stats:
        add_stat_callout(slide, value, label, x, Inches(1.7), Inches(2.9), Inches(1.4),
                         value_color=DEEP_BLUE, value_size=42)
        x += Inches(3.05)

    # Universe + sourcing details
    add_text(slide, "Universe",
    ...
    add_text(slide,
             ...
             Inches(0.8), Inches(4.5), Inches(11.7), Inches(0.5),
             font_size=12, color=TEXT_MUTED)

    add_text(slide, "Source & period",
    ...
    add_text(slide,
             ...
             Inches(0.8), Inches(5.65), Inches(11.7), Inches(1),
             font_size=14, color=TEXT_DARK)
...
def slide_07_design_eda(prs, data, results_dir):
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "Design — EDA findings",
                     "Three findings shaped every downstream choice")
    ...
    for head, body in cards:
        ...
        card = slide.shapes.add_shape(
            MSO_SHAPE.ROUNDED_RECTANGLE, x, Inches(1.8),
            Inches(4), Inches(2.3)
        )
        card.fill.solid()
        ...
        add_text(slide, head, x + Inches(0.3), Inches(2.0),
                 Inches(3.6), Inches(0.6),
                 font_size=16, bold=True, color=DEEP_BLUE)
        add_text(slide, body, x + Inches(0.3), Inches(2.6),
    ...
    if corr_path.exists():
        add_image_fitted(slide, corr_path,
                         Inches(3.3), Inches(4.3),
                         Inches(6.7), Inches(2.9))
        add_text(slide, "Return correlation matrix (universe)",
                 Inches(3.3), Inches(7.1), Inches(6.7), Inches(0.3),
...
def slide_08_design_process(prs, data):
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "Design — pipeline architecture",
    ...
    for i, (title, body, color) in enumerate(steps):
        ...
        add_text(slide, title, x, y + Inches(0.15), box_w, Inches(0.4),
                 font_size=16, bold=True, color=WHITE,
                 align=PP_ALIGN.CENTER, font=HEADER_FONT)
        add_text(slide, body, x, y + Inches(0.6), box_w, Inches(1.0),
        ...
        if i < len(steps) - 1:
            arrow = slide.shapes.add_shape(
                ...
                x + box_w + Inches(0.01), y + Inches(0.65),
    ...
    add_text(slide,
             ...
             Inches(0.8), Inches(4.6), Inches(11.7), Inches(0.4),
             font_size=13, color=TEXT_MUTED, align=PP_ALIGN.CENTER, font=BODY_FONT)

    # Below: design choices
    add_text(slide, "Key design choices",
             Inches(0.8), Inches(5.2), Inches(11), Inches(0.4),
             font_size=18, bold=True, color=DEEP_BLUE)
    ...
    add_bullets(slide, choices, Inches(0.8), Inches(5.7), Inches(11.7), Inches(1.6),
                font_size=13)
...
def slide_09_deliver_features(prs, data, results_dir):
    ...
    for (left, top), (num, title, sub, desc) in zip(positions, families):
        ...
        circle.line.fill.background()
        add_text(slide, num, left, top, Inches(0.7), Inches(0.7),
                 font_size=14, bold=True, color=WHITE,
                 align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)

        add_text(slide, title, left + Inches(0.85), top - Inches(0.05),
                 Inches(5.2), Inches(0.4),
                 font_size=18, bold=True, color=DEEP_BLUE)
        add_text(slide, sub, left + Inches(0.85), top + Inches(0.4),
                 Inches(5.2), Inches(0.35),
                 font_size=13, color=ACCENT, bold=True, font=BODY_FONT)
        add_text(slide, desc, left + Inches(0.85), top + Inches(0.85),
...
def slide_10_deliver_models(prs, data, results_dir):
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "Deliver — model comparison",
    ...
    best = max(model_order,
               key=lambda m: (models_metrics.get(m, {}).get("mean_auc", 0),
                              tiebreak.get(m, 0)))
    ...
    for model_key in model_order:
        ...
        for lbl, val in metrics_to_show:
            add_text(slide, f"{val:.3f}",
                     x + Inches(0.3), my,
                     col_w - Inches(0.6), Inches(0.5),
                     font_size=24, bold=True, color=value_color,
                     align=PP_ALIGN.CENTER, font=HEADER_FONT)
            add_text(slide, lbl,
                     x + Inches(0.3), my + Inches(0.5),
                     col_w - Inches(0.6), Inches(0.3),
...
def slide_11_deliver_equity_curve(prs, data, results_dir):
    ...
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "Deliver — backtest equity curves",
    ...
    if chart_path.exists():
        add_image_fitted(slide, chart_path,
    ...
    box1 = slide.shapes.add_shape(
        MSO_SHAPE.ROUNDED_RECTANGLE, Inches(9.5), Inches(1.8),
        Inches(3.4), Inches(1.6)
    )
    box1.fill.solid()
    ...
    add_text(slide, "ML STRATEGY",
             Inches(9.5), Inches(1.95), Inches(3.4), Inches(0.3),
             font_size=11, bold=True, color=ACCENT,
             align=PP_ALIGN.CENTER)
    add_text(slide, f"${10000 * (1 + strategy['total_return']):,.0f}",
             Inches(9.5), Inches(2.25), Inches(3.4), Inches(0.7),
             font_size=32, bold=True, color=WHITE,
             align=PP_ALIGN.CENTER, font=HEADER_FONT)
    add_text(slide, f"{strategy['annualized_return']*100:.1f}% annualized",
             Inches(9.5), Inches(2.95), Inches(3.4), Inches(0.3),
             font_size=12, color=RGBColor(0xCA, 0xDC, 0xFC),
             align=PP_ALIGN.CENTER)

    # Equal-Weight
    box2 = slide.shapes.add_shape(
        MSO_SHAPE.ROUNDED_RECTANGLE, Inches(9.5), Inches(3.6),
    ...
    add_text(slide, "EQUAL-WEIGHT", Inches(9.5), Inches(3.75),
             Inches(3.4), Inches(0.3),
             font_size=11, bold=True, color=TEAL,
             align=PP_ALIGN.CENTER)
    add_text(slide, f"${10000 * (1 + eq['total_return']):,.0f}",
             Inches(9.5), Inches(4.05), Inches(3.4), Inches(0.6),
             font_size=26, bold=True, color=DEEP_BLUE,
             align=PP_ALIGN.CENTER, font=HEADER_FONT)
    add_text(slide, f"{eq['annualized_return']*100:.1f}% annualized",
             Inches(9.5), Inches(4.65), Inches(3.4), Inches(0.3),
             font_size=11, color=TEXT_MUTED,
             align=PP_ALIGN.CENTER)

    # Alpha box
    box3 = slide.shapes.add_shape(
        MSO_SHAPE.ROUNDED_RECTANGLE, Inches(9.5), Inches(5.2),
    ...
    add_text(slide, "HONEST ALPHA",
             Inches(9.5), Inches(5.35), Inches(3.4), Inches(0.3),
             font_size=11, bold=True, color=WHITE,
             align=PP_ALIGN.CENTER)
    add_text(slide, f"+{alpha_pp:.2f}pp",
             Inches(9.5), Inches(5.65), Inches(3.4), Inches(0.7),
             font_size=32, bold=True, color=WHITE,
             align=PP_ALIGN.CENTER, font=HEADER_FONT)
    add_text(slide, f"+{sharpe_advantage:.2f} Sharpe vs. equal-weight",
             Inches(9.5), Inches(6.4), Inches(3.4), Inches(0.4),
             font_size=11, color=WHITE,
             align=PP_ALIGN.CENTER)
...
def slide_12_deliver_performance(prs, data, results_dir):
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "Deliver — performance breakdown",
    ...
    for i, (h, c) in enumerate(zip(headers, header_colors)):
        ...
        # Header background
        bg = slide.shapes.add_shape(
            MSO_SHAPE.RECTANGLE, x, table_top, w, row_h
        )
        bg.fill.solid()
        bg.fill.fore_color.rgb = c
        bg.line.fill.background()
        add_text(slide, h, x, table_top, w, row_h,
    ...
    for row_idx, (label, key, fmt) in enumerate(metrics):
        ...
        # Metric name
        add_text(slide, label, table_left + Inches(0.2), y, col1_w, row_h,
                 font_size=14, color=TEXT_DARK,
        ...
        for k, color in keys:
            val = bt[k].get(key, 0)
            if fmt == "pct":
                txt = f"{val*100:+.2f}%" if key == "max_drawdown" or "return" in key.lower() else f"{val*100:.2f}%"
                if key == "hit_rate":
                    txt = f"{val*100:.1f}%"
            else:
                txt = f"{val:.2f}"
            ...
            add_text(slide, txt, x, y, col_w, row_h,
                     font_size=15,
                     bold=best_in_row,
                     color=text_color,
                     align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE,
    ...
    add_text(slide,
             ...
             font_size=12, color=TEXT_MUTED, align=PP_ALIGN.CENTER, bold=True)
...
def slide_13_deliver_risk(prs, data, results_dir):
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "Deliver — risk and drawdown",
    ...
    if dd_path.exists():
        add_image_fitted(slide, dd_path,
                         Inches(0.6), Inches(1.7),
                         Inches(7.5), Inches(4.0))

    # Risk discussion on the right
    add_text(slide, "What the chart shows",
             Inches(8.4), Inches(1.8), Inches(4.5), Inches(0.4),
             font_size=18, bold=True, color=DEEP_BLUE)
    ...
    add_bullets(slide, risk_bullets, Inches(8.4), Inches(2.3),
                Inches(4.5), Inches(2),
                font_size=13)

    add_text(slide, "Honest framing",
             Inches(8.4), Inches(4.4), Inches(4.5), Inches(0.4),
    ...
    add_bullets(slide, framing, Inches(8.4), Inches(4.9),
                Inches(4.5), Inches(2),
                font_size=13)
    ...
    for value, label, color in stats:
        add_stat_callout(slide, value, label, x, Inches(6.1),
                         Inches(2.4), Inches(1.0),
                         value_color=color, value_size=28)
        x += Inches(2.6)
...
def slide_14_solution(prs, data):
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    add_background(slide, WHITE)
    add_slide_header(slide, "End-to-end solution",
                     "What I shipped — reproducible, documented, deployable")

    # Two columns: code structure | what each delivers
    add_text(slide, "Pipeline modules",
             Inches(0.8), Inches(1.7), Inches(6), Inches(0.4),
             font_size=20, bold=True, color=DEEP_BLUE)
    ...
    for name, desc in modules:
        ...
        add_text(slide, name, Inches(0.8), y, Inches(2.8), Inches(0.4),
                 font_size=14, bold=True, color=TEAL,
                 font="Consolas")
        add_text(slide, desc, Inches(3.7), y, Inches(3.5), Inches(0.4),
                 font_size=14, color=TEXT_DARK)
        y += Inches(0.55)

    # Right: deliverables
    add_text(slide, "Deliverables",
             Inches(7.8), Inches(1.7), Inches(5.2), Inches(0.4),
             font_size=20, bold=True, color=DEEP_BLUE)
    ...
    add_bullets(slide, deliverables, Inches(7.8), Inches(2.3),
...
def slide_15_summary(prs, data):
    ...
    bt = data["backtest"]
    alpha_pp = (bt["strategy"]["annualized_return"]
                - bt["equal_weight"]["annualized_return"]) * 100
    ...
    for (head, color), bullets in zip(headers, contents):
        ...
        add_text(slide, head, x, Inches(1.9), col_w, Inches(0.5),
                 font_size=20, bold=True, color=color, font=HEADER_FONT)

        add_bullets(slide, bullets, x, Inches(2.5), col_w, Inches(4.5),
...
def slide_16_thanks(prs, data):
    ...
    add_text(slide, "Thank you",
             ...
             font_size=80, bold=True, color=WHITE, font=HEADER_FONT)

    add_text(slide, "Happy to dig into any part of the pipeline.",
             Inches(0.8), Inches(4.2), Inches(11.5), Inches(0.6),
             font_size=22, color=RGBColor(0xCA, 0xDC, 0xFC), font=BODY_FONT)

    add_text(slide, "Jordan Donaldson",
             Inches(0.8), Inches(6.3), Inches(8), Inches(0.4),
             font_size=18, bold=True, color=WHITE)
    add_text(slide,
             "github.com/Jordan4184/swing-trading-capstone   |   itsjordandonaldson@gmail.com",
             Inches(0.8), Inches(6.75), Inches(11), Inches(0.4),
